...
object SvelteTSElementTypes {
  const val STUB_VERSION = 2

  val CONST_TAG_VARIABLE: TypeScriptVariableElementType = object : TypeScriptVariableElementType("CONST_TAG_VARIABLE") {
  ...
  val EMBEDDED_CONTENT_MODULE_TS = object : TypeScriptEmbeddedContentElementType(SvelteJSLanguage.INSTANCE, "MOD_SVELTE_TS_") {
    override fun isModule() = true
    override fun toModule() = this
